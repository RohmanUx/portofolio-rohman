  ...
  return (
    <div>
      ...
      <div className="w-full px-3 fixed  sm:px-8 md:px-14 lg:px-[125px] z-50 mt-4 rounded-full mx-0">
        ...
        <div
          className={`fixed top-0 left-0 w-full bg-black/10 bg-opacity-60 backdrop-blur-3xl shadow-md z-40 py-2 md:hidden transition-transform transform border-b border-white/10 flex justify-center flex-col items-end px-10 pt-5 ${
