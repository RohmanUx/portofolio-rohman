            ...
            <div className="h-[600px] flex justify-center flex-col items-center">
              ...
              >
                <div className="relative text-center ">
                                    <h1 className="relative m-0 text-custom font-medium leading-none tracking-custom bg-gradient-to-r from-clr-1 to-clr-4 bg-clip-text text-transparent stroke-[4px] animate-aurora-gradient font-sans">
                    Berminat!! 
                  </h1>
