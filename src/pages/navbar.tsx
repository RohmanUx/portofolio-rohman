...
function Navbar() {
  ...
  <div> 
    ...
    <div style={{ display: "flex", alignItems: "center", backgroundColor: "White", padding: "24px" , justifyContent: 'space-between'}}>
      <div id='logo'>     
      <h1 id='logo-0'  style={{ fontSize: 24, fontWeight: 600, marginLeft: 10, color: 'black'}}> Gembase </h1>
      ...
      <div id="menu">
        <ul style={{ display: 'flex', listStyle: "none", gap: 50, justifyContent: 'center', fontSize: 16}}>   
          ...
          <li>
            <Link to="/"> For personal </Link>
          </li> 
           <li> 
            <Link to="/"> For businnes</Link>
          </li>
          <li>
     ...
     { /* hero page */ }
                 <div id='container-2'>  
                    <div id='item-1'> 
                    <p id='list-1'> peace of mind for your finance </p>
                    <h1 id='list-2'> Experience an Easy <br /> Way to Manage <br /> Finance </h1>  
                    ...
                    <button id='button-3'> get started</button>
                    </div>
                    <div id='item-2'> 
            
                        </div> 
                            <div id='item-3'>  
                        <p id='list-4'> <q>excelent interface, super easy to use. <br /> by far the best money management and <br /> planning app i've use.</q>  </p>
                            <div id='img-0'> <img id='img'    src='https://cdn.dribbble.com/userupload/15332517/file/original-a64cd79737df1ee5c2451eb8c825a5d5.png?resize=1200x900' width={50} height={50}></img>
                             <div> 
                              ...
                              <p id='list-6'> costumer service  </p>  </div>    </div> 
                                 </div>                   
                 </div>
               <div id='patrner'> 
                <div id='partner-1'> Binance</div>
                <div id='partner-2'> Fbs</div>
                <div id='partner-3'> Meta</div>
                <div id='partner-4'> Pintu</div>
                <div id='partner-5'> Traveloka </div>
               </div>
               
               { /* page 2 */ } 
               <div id='pro'> 
                <div id='pro-1'> 
                    <div id='pro-1-0'> <div id='pro-1-2'> No.1 Rank <br /> by Hasburg <br /> university  </div> </div>
                </div>
                 
                <div id='pro-2'>  <div id='pro-2-0'> 
                    <p id='program-3'> for propesional </p> <br /> 
                    <h1 id='program-4'> Easily manage Your <br /> Finance & grow  <br /> Money  </h1>  
                    <p id='program-5'> we're the most trusted place for people and businesses to <br /> track all of your account balances, transactions, and <br /> investment in one place </p> <br />  
                     <button id='button-0'> get started</button>    </div>       
                 </div>  
               ...
               <div id='page-3'> 
                <div id='page-3-0'> <div id='page-3-2'> 
                    <p id='list-7'> 310$ trust & syndicate</p> <br />  
                    <p id='list-8'> 30m+ Using gen Base </p> </div>  
                    <h1 id='list-9'> The Freedom of finance for <br /> everyone, everywhere </h1>  
                    <p id='list-10'> we're the most trusted place for people and businesses to <br /> track all of your account balances, transactions, and investment in one place </p> 
                    <button id='button-5'> get started  </button>   </div> 
                    </div>  
          ...
          { /*  page 4 */ }
             ...
             <div id='page-4'> 
                      <div id='page-4-0'> 
                        <h1 id='list-15'> Providing solution to all <br /> financial problem</h1>
                        <p id='list-16'> Change the way you do money - from your side hustie to your every <br /> day Spending, at home or abroad.  </p>
                      </div> 
                       <div id='page-4-2'> 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#000000" id='img-1'> <path d="M448.67-195.33h60v-51.34q57.33-7.66 92-38 34.66-30.33 34.66-84 0-48-27.33-81t-97.33-61Q452-533.33 427-551q-25-17.67-25-47.67Q402-628 423.17-645q21.16-17 58.83-17 30.67 0 51.33 14.5Q554-633 566.67-606.67l53.33-24q-15-35-43.5-57t-65.83-25.66V-764h-60v50.67Q400-705 371-673.67q-29 31.34-29 75 0 48.34 29.17 77.34 29.16 29 88.83 52.66 65.67 26.34 90.5 47.34 24.83 21 24.83 52.66 0 32.34-25.5 50.5Q524.33-300 486.67-300q-37 0-65.84-21.5Q392-343 380-382l-56 20q18.67 46.67 48.83 74.17 30.17 27.5 75.84 39.16v53.34ZM480-80q-82.33 0-155.33-31.5-73-31.5-127.34-85.83Q143-251.67 111.5-324.67T80-480q0-83 31.5-156t85.83-127q54.34-54 127.34-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 82.33-31.5 155.33-31.5 73-85.5 127.34Q709-143 636-111.5T480-80Zm0-66.67q139.33 0 236.33-97.33t97-236q0-139.33-97-236.33t-236.33-97q-138.67 0-236 97-97.33 97-97.33 236.33 0 138.67 97.33 236 97.33 97.33 236 97.33ZM480-480Z"/> </svg> 
                       <div id='room-0'> <div id='img-2'>  saving  </div> 
             ...
             <div id='page-5'> 
                    <h1 id='list-11'> Ready to star a new <br /> Exsperiuence </h1>  
                    ...
                    <button id='button-13'> get started</button>           
                    <p id='list-14'> Gembase</p>
                    </div>  
      { /* navbar */ } 

       <div id='page-6'> 
<div id='page-6-0'> 
  <h1 id='list-21'> Gembase </h1> 
  <p> we're the most trusted place for <br /> people and businesses to
  track all of your <br /> account balances, transactions, <br /> and investment in one place <br /> in word.  </p> 
  <div> <img></img>   </div>
  <div> <img></img>   </div>
</div>
...
<div id='page-6-2'> 
  <ul> 
    <li id='list-22'> build with Us:  </li>  
    <li> businnes </li>  
    <li> help </li>  
    <li> talk </li>  
    <li> meeting </li>  
...
<div id='page-6-3'> 
  <ul> 
    <li id='list-22'> partner with us: </li>  
    <li> api luno </li>  
    <li> node vps  </li>  
    <li> crypto chain </li>  
    <li> atlass protocol </li>  
    <li> danke donation </li>  
  </ul>
  </div>     </div>    

<div id='page-6-4'> 
  <p> @2024 rohman, All right served</p>  
