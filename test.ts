...
// .splice * 
// non index 0 #### 
// .padStart .pop .push .shift .unshift * 

// ARRAY OR STRING SOMEONE CAN IT ##### || 
// only string #### ~
...
// Hitungan var pertama it Output (var kedua alat untuk pertama) #### 
...
// lenght * 
// only object #### ~ 
// Onject.value Object.keys Object.entries * 
// array.from * 

// DOUBLE WANT . ARRAY STRING OBJECT #### || 
// should array & string #### 
// .concat   (add text yg udah ada) 
// .toString (string / array ke string) 
// isNaN * 
// array.from * 
// should string & object #### 
// array.from (convert array biasa, sebelumnya tidak biasa / dia string) 
...
// only can output #### 
// array.isAaaray (check apakah array jika bukan false)
...
// isNaN (check bukan number jika number: false)  * 
...
// ---------------------------------------------------
// KESAMAAN #### 
// check : isNan = bukan number, array.isArray = check array, isFinite = check number / number string, include = check item ada 
// convert : toString = string / array / array string ke string, object.entries = object ke array, fromEntries = array ke object 


// style funtion inside () #### 
...
// .some .every match.random .match 
// .send (mengirim respond dari back end) Multer.file[] (menyimpan doc / image ke array file) local.decript.res 


// total = 52 method 
// total index , index keberapa ## 
